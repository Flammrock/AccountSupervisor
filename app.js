...
function activities() {
	var activities_list = [
		...
		["😝 I will help u if u send me +help","WATCHING"],
		["I update my database 😎","WATCHING"], 
		["I always listen u","WATCHING"],
		["#stayathome 😐","WATCHING"],
		["#restezchezvous 😐","WATCHING"],
		["Hello","WATCHING"],
		["Hi :)","WATCHING"],
		["It's Muffin Times! 😂","WATCHING"],
		["Yeah Man 😎","WATCHING"],
		["You are my bro 😘","WATCHING"],
		["😴 I just woke up, did I miss something? 😴","WATCHING"],
		["😱😱😱😱😱😱😱😱😱😱","WATCHING"],
		["💩","WATCHING"],
		["🤖 Something is wrong, i can feel it!","WATCHING"],
		["Are u ok?","WATCHING"],
		["I work hard for u! can i have choco 🍫 ??","WATCHING"],
		["About 73,600,000 results (0.57 seconds)","WATCHING"],
		["🤯I am moving though the web!! 🤯🤯","WATCHING"],
		["My Creator is a cool French🇫🇷 Guy 🥖","WATCHING"],
		["I'm cool Bot!! 😆","WATCHING"],
		["I'm in the matrix","WATCHING"],
		["Can u beat me?","WATCHING"],
		["my finger is too big!","WATCHING"],
		["Sleeping......","WATCHING"],
		["oh oh oh...🎅🏻🎅🏻","WATCHING"],
		["👨🏻‍💻","WATCHING"]
    ];
